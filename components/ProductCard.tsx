  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-4 flex flex-col flex-grow">
          <Link href={`/product/${product.slug}`}>
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 hover:text-primary-600 transition-colors line-clamp-2 min-h-[3rem] sm:min-h-[3.5rem]">
            {product.name}
          </h3>
        </Link>
        <div className="mb-2 sm:mb-3 flex-grow">
          {product.description ? (
            <p className="text-gray-600 text-xs sm:text-sm line-clamp-2 min-h-[2rem] sm:min-h-[2.5rem]">
              {product.description}
            </p>
          ) : (
            <div className="min-h-[2rem] sm:min-h-[2.5rem]"></div>
          )}
        </div>
        ...
        <div className="flex gap-1.5 sm:gap-2 flex-shrink-0">
          <Link
            ...
            className="flex-1 flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 bg-gray-100 text-gray-700 rounded hover:bg-gray-200 transition-colors text-sm sm:text-base"
          >
          ...
          <motion.button
            ...
            className="flex-1 flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 bg-primary-600 text-white rounded hover:bg-primary-700 transition-colors text-sm sm:text-base"
          >
